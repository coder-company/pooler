...
fn auth_schema() -> Value {
    object_schema(
        properties([
            ...
            ("secret", optional(reference("secret_ref"))),
            ("header", optional(string_schema())),
            ("value_prefix", optional(string_schema())),
        ]),
        &[],
        false,
    )
...
fn model_target_schema() -> Value {
    let mut schema = object_schema(
        properties([
            ...
            ("parameters", array_schema(nonempty_string(), Some(0), None)),
            ("context_window", optional(u64_schema())),
            (
                "quantization",
                array_schema(nonempty_string(), Some(0), None),
            ),
            ("privacy", optional(nonempty_string())),
            ("zdr", optional(boolean_schema())),
            ("data_policy", optional(nonempty_string())),
            ("region", optional(nonempty_string())),
            ("price", optional(u64_schema())),
...
fn routing_preference_schema() -> Value {
    object_schema(
        properties([
            ...
            ("max_latency_ms", optional(u64_schema())),
            ("min_throughput", optional(u64_schema())),
            ("min_samples", optional(u64_schema())),
            ("stale_after_ms", optional(u64_schema())),
        ]),
        &[],
        false,
    )
...
fn routing_schema() -> Value {
    object_schema(
        properties([
            ...
            ("target_order", array_schema(id_schema(), Some(0), None)),
            ("allow", array_schema(id_schema(), Some(0), None)),
            ("only", array_schema(id_schema(), Some(0), None)),
            ("deny", array_schema(id_schema(), Some(0), None)),
            ("ignore", array_schema(id_schema(), Some(0), None)),
            ("target_allow", array_schema(id_schema(), Some(0), None)),
            ("target_deny", array_schema(id_schema(), Some(0), None)),
            ("allow_fallbacks", optional(boolean_schema())),
            ("fallback_models", array_schema(id_schema(), Some(0), None)),
            (
                "required_parameters",
                array_schema(nonempty_string(), Some(0), None),
            ),
